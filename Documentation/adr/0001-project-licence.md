...
Inbound `References/`: Stylus and AdGuard Home are GPL-3.0; userstyles.world is AGPL-3.0; KeePassXC is GPL-2.0-or-later; Violentmonkey and mitmproxy are MIT; Rethink is Apache-2.0. Study trees on disk are not derivatives. Copying into `apps/` or `packages/` is.
